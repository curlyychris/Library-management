...
$books = $bookRepository->getBooks($search, $searchBy, null);
?>
...
<body>
    ...
    <form action="./all_books.php" class="pb-5 pt-5" method="GET">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                <a href="../Views/book_details_view.php?id=<?= htmlspecialchars($book->book_id) ?>" class="btn btn-primary">View</a>
                            </div>
                        </div>
                    </div>
                </div>
